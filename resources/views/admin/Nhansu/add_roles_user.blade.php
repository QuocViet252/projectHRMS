                    ...
                    <div class="card-body">
                       <ul>
                        @foreach($users as $user)
                            <li><input type="checkbox" name="permissions[]" value="{{$user->id}}" 
                                @if($role->users->contains($user->id)) checked=checked @endif> {{$user->name}}</li>
                        @endforeach
                       </ul>
                    </div>
                </div>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @if($role->users->contains($user->id)) checked=checked @endif> {{$user->name}}
                                            @endforeach
                                            </td>
                                        </tr>
                                        @endforeach
